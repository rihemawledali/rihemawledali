...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Convention c1 = conventionRepository.save(Convention.builder()
                ...
                .typeAvantage(com.project_pfe_srt.project_srt.shared.convention.entity.TypeAvantage.ABONNEMENT)
                .montantAvantage(600.0)
                .pourcentageAdherent(30.0)
                .nombreMoisRetenue(6)
                .description("Abonnement pharmacie familial — 600 TND/an, 30% adhérent").build());
        Convention c2 = conventionRepository.save(Convention.builder()
                ...
                .typeAvantage(com.project_pfe_srt.project_srt.shared.convention.entity.TypeAvantage.BON_ACHAT)
                .montantAvantage(300.0)
                .pourcentageAdherent(50.0)
                .nombreMoisRetenue(3)
                .description("Bons repas midi — 300 TND, 50% adhérent sur 3 mois").build());
        ...
        conventionDemandeRepository.save(ConventionDemande.builder()
                ...
                .commentaire("Demande pour bénéficier de l'abonnement pharmacie familial.")
                .build());
        conventionDemandeRepository.save(ConventionDemande.builder()
                .convention(c2).adherent(adh)
                .dateDemande(LocalDate.of(2025, 4, 20))
                .statut("APPROUVEE")
                .dateDecision(LocalDate.of(2025, 4, 22))
                .commentaire("Souhaite bénéficier des bons repas du midi.")
                .build());
        conventionDemandeRepository.save(ConventionDemande.builder()
