...
public class HistoriqueTresorerieDto {
    ...
    public static HistoriqueTresorerieDto from(HistoriqueTresorerie h) {
        ...
        return HistoriqueTresorerieDto.builder()
                ...
                .compteBancaireId(h.getCompteBancaire() == null ? null : h.getCompteBancaire().getId().toString())
                .compteBancaireBanque(h.getCompteBancaire() == null ? null : h.getCompteBancaire().getBanque())
                .build();
    }
}
