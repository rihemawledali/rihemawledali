...
import type { BonStatus, TicketType } from '../../../shared/types/domain';
...
export function BonCommandeForm({ initial, onSubmit, onCancel, submitting }: any) {
  ...
  const initialValues: BonCommandeFormValues = initial
    ? {
