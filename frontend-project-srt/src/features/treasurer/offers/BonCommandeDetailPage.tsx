...
import type { BonStatus } from '../../../shared/types/domain';
...
export function BonCommandeDetailPage() {
  ...
  const ticketPath = '/treasurer/tickets';
...
function OfferDetailMetric(props: any) {
  return <SimpleMetricCard {...props} className="offer-metric" tonePrefix="offer-metric--" tone="primary" />;
}
