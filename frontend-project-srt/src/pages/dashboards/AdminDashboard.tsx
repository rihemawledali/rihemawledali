    ...
    <div className="dashboard">
      <header className="dashboard-header">
        ...
        <div className="dashboard-header-right">
          <span className="dashboard-user-info">
            ...
            <span className="dashboard-role-badge dashboard-role-badge--admin">Admin</span>
          </span>
      ...
      <main className="dashboard-content">
        <div className="dashboard-welcome-card">
          ...
          <p>You are logged in as <strong>Administrator</strong>. You have full access to all system features.</p>
        </div>
        <div className="dashboard-stats-grid">
          <div className="dashboard-stat-card">
            <span className="dashboard-stat-number">24</span>
            <span className="dashboard-stat-label">Total Users</span>
          </div>
          <div className="dashboard-stat-card">
            <span className="dashboard-stat-number">8</span>
            <span className="dashboard-stat-label">Active Sessions</span>
          </div>
          <div className="dashboard-stat-card">
