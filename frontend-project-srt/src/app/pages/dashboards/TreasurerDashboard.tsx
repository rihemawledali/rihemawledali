/* ============================================
   Dashboard Placeholder — Treasurer
   ============================================ */
    ...
    <div className="dashboard">
      <header className="dashboard-header">
        ...
        <div className="dashboard-header-right">
          <span className="dashboard-user-info">
            ...
            <span className="dashboard-role-badge dashboard-role-badge--treasurer">Treasurer</span>
          </span>
      ...
      <main className="dashboard-content">
        <div className="dashboard-welcome-card">
          ...
          <p>You are logged in as <strong>Treasurer</strong>. Manage financial records and transactions.</p>
        </div>
        <div className="dashboard-stats-grid">
          <div className="dashboard-stat-card">
            <span className="dashboard-stat-number">€12,450</span>
            <span className="dashboard-stat-label">Total Balance</span>
          </div>
          <div className="dashboard-stat-card">
            <span className="dashboard-stat-number">15</span>
            <span className="dashboard-stat-label">Transactions</span>
          </div>
          <div className="dashboard-stat-card">
            <span className="dashboard-stat-number">5</span>
            <span className="dashboard-stat-label">Pending Approvals</span>
          </div>
        </div>
      </main>
    </div>
